...
и источниками из раздела "Дополнительные ссылки" данного ДЗ.
	 ...
	 (с)Вот оно чо. Видел такое на скринах коллег из смежных систем. От шиномонажников(тибко) тоже. Может и нам прикрутить такое... хотя мы прям в БД сопровождаемых ИС ищем. и иногда в логах... Интересно, как это будет все работать если нагруз тест это не учитывал...
